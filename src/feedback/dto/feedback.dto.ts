import { IsString, IsNotEmpty, MinLength, MaxLength, IsOptional, IsInt, Min, Max, IsPositive, IsEnum, IsArray, ArrayNotEmpty } from 'class-validator';
...
export class BulkDeleteFeedbackDto {
  @ApiProperty({ 
    example: [1, 2, 3], 
    description: 'Array of feedback IDs to delete',
    type: [Number]
  })
  @IsArray()
  @ArrayNotEmpty()
